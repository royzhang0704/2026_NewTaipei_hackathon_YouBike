...
這些資源目前都已經建好（見上表），不用重做；這裡記錄「當初怎麼建出來的」，給之後要在別的帳號／
...
[Create a knowledge base（S3 data source）](https://docs.aws.amazon.com/bedrock/latest/userguide/knowledge-base-create.html)、
[Models and instructions（Harness）](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/harness-models.html)。
