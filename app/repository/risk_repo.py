...
#      ⚠ 9/12 起 streak 只算高風險（見 batch_predict.write_risk），中低風險
#        的 streak_n 一律 0 —— 這一鍵實際上**只在高風險群組內**起作用，
#        中低風險群組會直接跳到第⑤鍵。這是可以接受的：中低風險在②③就已經
#        排出意義了，而且中低的定義是「預測 1~3 小時內會越線」，每輪隨預測
#        擺動亮滅，累計時數本來就沒有調度意義。
